          ...
          >
            ...
            >
              ...
              <div className="flex gap-3 ml-2">
                ...
                <a href="/resume.pdf" className="w-[40px] h-[40px] rounded-full border border-[var(--border)] flex justify-center items-center text-[var(--muted)] hover:border-[var(--cyan)] hover:text-[var(--cyan)] hover:scale-[1.1] transition-all">
